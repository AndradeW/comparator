(function () {
  ...
  var VOLATILE_HEADERS = ["date", "age", "cf-ray", "set-cookie", "via", "expires", "x-cache", "x-cache-hits", "x-served-by", "x-request-id", "report-to", "reporting-endpoints", "nel", "server-timing"];
